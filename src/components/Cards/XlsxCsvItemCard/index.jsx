...
export default function XlsxCsvItemCard(props) {
  ...
  if (props.merged && props.files) {
    ...
    return (
      <div className="w-full flex border hover:shadow-lg border-gray-300 rounded-lg shadow-sm p-4 transition-transform duration-500 ease-in-out justify-between">
