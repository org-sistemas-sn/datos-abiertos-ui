export default function CategoryHomeCard({ icon, label }) {
  return (
    <div className="max-w-[450px] lg:max-w-[250px] flex items-center cursor-pointer select-none p-4 md:p-0 md:h-20 md:w-full bg-white border rounded-lg shadow transition-transform duration-500 ease-in-out hover:shadow-lg hover:scale-105 lg:h-[100px]">
