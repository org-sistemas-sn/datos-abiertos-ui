...
export default function CardEventCalendary({ day, title, bgColor }) {
  return (
    <div className="flex w-full h-20 items-center cursor-pointer select-none p-4 bg-white border rounded-lg shadow transition-transform duration-500 ease-in-out hover:shadow-lg hover:scale-105 lg:max-w-[400px]">
      <div
